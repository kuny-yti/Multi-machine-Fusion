...
public:
    dispatch( msg::level_t log_level,
    ...
    static const class audio_output* audio_output();
    static const class video_output* video_output();
    static void video_output(class video_output* );
    static const class media_input* media_input();
    static bool playing();
    static bool pausing();
